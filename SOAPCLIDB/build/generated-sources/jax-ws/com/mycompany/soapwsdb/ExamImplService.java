 ...
 * 
 */
@WebServiceClient(name = "ExamImplService", targetNamespace = "http://soapwsdb.mycompany.com/", wsdlLocation = "http://localhost:8080/MovieDatabase?wsdl")
    ...
    extends Service
{
    ...
    private final static QName EXAMIMPLSERVICE_QNAME = new QName("http://soapwsdb.mycompany.com/", "ExamImplService");
    ...
    public Exam getExamImplPort() {
        return super.getPort(new QName("http://soapwsdb.mycompany.com/", "ExamImplPort"), Exam.class);
    }
    ...
    public Exam getExamImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://soapwsdb.mycompany.com/", "ExamImplPort"), Exam.class, features);
    }
